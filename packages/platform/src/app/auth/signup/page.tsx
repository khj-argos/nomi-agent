  ...
  if (isSuccess) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-zinc-50 px-4 py-12">
        <div className="w-full max-w-md space-y-8 bg-white p-8 rounded-3xl shadow-xl border border-zinc-100 text-center">
          ...
          <p className="text-zinc-500 leading-relaxed">
            ...
            인증 링크를 보내드렸습니다.
            <br />
            이메일 인증을 완료하면 가입이 완료됩니다.
          </p>
          <div className="pt-6">
            <Link
              href="/auth/login"
              className="inline-flex justify-center items-center gap-2 bg-zinc-50 text-zinc-700 font-medium px-6 py-3 rounded-full hover:bg-zinc-100 transition-colors"
            >
              로그인으로 돌아가기
            </Link>
          </div>
